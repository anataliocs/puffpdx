...
/**
 * Created by chris.anatalio on 12/5/16.
 */
public class WiremockResponses {

    //TODO Replace this with Wiremock
    public static final String strainsResponseBody = "{\n" + "  \"data\": [\n" + "    {\n" + "      \"name\": \"13 Roses\",\n" + "      \"ucpc\": \"9XVU73HWRP000000000000000\",\n"
    ...
    public static final String effectsResponseBody = "{\n" +
        "  \"data\": {\n" +
        "    \"euphoria\": \"7.3000\",\n" +
        "    \"creativity\": \"8.2500\",\n" +
        "    \"calming\": \"5.7143\",\n" +
        "    \"numbness\": \"6.8750\",\n" +
        "    \"appetite_gain\": \"6.8571\",\n" +
        "    \"dry_mouth\": \"5.8750\",\n" +
        "    \"fruity\": \"3.3333\",\n" +
        "    \"spicy\": \"5.5714\",\n" +
        "    \"earthy\": \"7.1250\",\n" +
