...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "puffpdx@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "puffpdx API";

        private String description = "puffpdx API documentation";
